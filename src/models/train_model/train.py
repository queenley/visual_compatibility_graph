...
def make_parser():
    ...
    ap.add_argument("-op", "--optimizer", type=str, default="adam", choices=["adam", "sgd"],
...
if __name__ == "__main__":
    ...
    res_adj_q, res_q_r_indices, res_q_c_indices, res_q_labels, res_q_ids, res_q_valid = dl.get_test_questions(
                                                                                                    resampled=True)
    ...
    if VERBOSE:
        ...
        print('best validation score =', best_val_score,
              'at iteration {}, with a train_score of {}'.format(best_epoch, best_epoch_train_score))
